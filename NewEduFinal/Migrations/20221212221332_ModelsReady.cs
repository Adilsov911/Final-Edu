        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(maxLength: 255, nullable: true),
                    Description = table.Column<string>(nullable: true),
                    StartTime = table.Column<string>(maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutCourseInfo = table.Column<string>(nullable: true),
                    CertificationInfo = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HobbiesId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassDuration = table.Column<string>(maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseFeatures_Courses_CoursesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseFeatures_CoursesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherHobbies_HobbiesId",
